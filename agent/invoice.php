...
$total_transaction_query = mysqli_query($conn, "SELECT * FROM transaction WHERE user_id='$user_id' && installment_num BETWEEN 1 AND '$yet_payment_month'");
				...
				<div class="card card-body p-0">
					<table class="table table-striped table-hover table-sm">
						...
						<tr>
							...
							<td>
							    <?php
							    $transaction_user_name_query = mysqli_fetch_assoc(mysqli_query($conn, "SELECT user_name FROM transaction WHERE id='$id'"));
							    echo $transaction_user_name_query['user_name'];
							    ?>
							</td>
							<td>CNIC:</td>
