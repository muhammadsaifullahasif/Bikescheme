...
if(isset($_GET['q'])) {
    ...
    if(mysqli_num_rows($q_query) > 0) {
        ...
        $query = "SELECT * FROM users WHERE id='$user_id' && role='2' && agent_id='$agent_id'";
							...
							<tr>
								...
								<td>
									<div class="btn-group">
                                        ...
                                        <button data-payid="<?php echo $id; ?>" class="btn btn-success add_payment_btn">Add Payment</button>
