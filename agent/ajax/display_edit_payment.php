...
if(isset($_POST['id'])) {
	...
	$output .= "<div class='mb-2' id='edit_form_msg'></div><form id='edit_form' class='modal-body'><div id='edit_form_msg'></div><input type='hidden' value='".$id."' id='edit_payment_id' name='edit_payment_id'>";
