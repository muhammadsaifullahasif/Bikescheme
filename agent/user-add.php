					...
					<div id="msg" class="mb-3">
						...
						if(isset($_POST['register_add_btn'])) {
							...
							if($agent_id != '' && $scheme_id != '' && $username != '' && $name != '' && $father_name != '' && $password != '' && $security_question != '' && $security_answer != '' && $gender != '' && $cnic != '' && $phone != '' && $address != '') {
								...
								if($query && $meta && $image) {
									echo "<div class='alert alert-success'><a href='#' data-dismiss='alert' class='close'>&times;</a>User is Successfully Added</div>";
								} else {
					...
					<form class="form" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<div class="form-check-inline">
								<input type="radio" class="form-check-input" required id="male" value="Male" name="gender">
								<label for="male" class="form-check-label">Male</label>
							</div>
							<div class="form-check-inline">
								<input type="radio" class="form-check-input" required id="female" value="Female" name="gender">
