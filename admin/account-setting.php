					...
					<div class="mb-2">
						...
						if(isset($_POST['change_username'])) {
							...
							if($old_username != '' && $new_username != '') {
								$check_username = mysqli_query($conn, "SELECT * FROM users WHERE user_login='$old_username' && role='0'");
								if(mysqli_num_rows($check_username) > 0) {
									$update_username = mysqli_query($conn, "UPDATE users SET user_login='$new_username' WHERE user_login='$old_username' && role='0'");
									if($update_username) {
										$_SESSION['bikescheme_admin_user_login'] = $new_username;
						...
						if(isset($_POST['change_password'])) {
							...
							if($old_password != '' && $new_password != '' && $confirm_password != '') {
								if($new_password == $confirm_password) {
									$check_pass = mysqli_query($conn, "SELECT user_pass FROM users WHERE user_login='$user_login' && role='0'");
									if(mysqli_num_rows($check_pass) > 0) {
										...
										if(password_verify($old_password, $check_pass_result['user_pass'])) {
											$update_password = mysqli_query($conn, "UPDATE users SET user_pass='$new_pass' WHERE user_login='$user_login' && role='0'");
											if($update_password) {
						...
						<div class="card mb-3">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Enter Old Username" id="old_username" name="old_username">
									<div id="old_username_msg"></div>
								</div>
								<div class="form-group">
									<label>New Username:</label>
									<input type="text" class="form-control" placeholder="Enter New Username" id="new_usename" name="new_username">
						...
						<div class="card mb-3">
							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" placeholder="Enter New Password Again" id="confirm_password" name="confirm_password">
