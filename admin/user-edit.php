				...
				<div class="card-body">
					<div class="mb-2">
						...
						if(isset($_POST['submit'])) {
							...
							if($agent != '' && $username != '' && $name != '' && $father_name != '' && $security_question != '' && $security_answer != '' && $gender != '' && $cnic != '' && $phone != '' && $address != '') {
								$update = mysqli_query($conn, "UPDATE users SET user_login='$username', user_email='$email', user_phone='$phone', active_status='$status', agent_id='$agent', introducer='$introducer' WHERE id='$id'");
								...
								$update_user_special_note = mysqli_query($conn, "UPDATE user_meta SET meta_value='$special_note' WHERE user_id='$id' && meta_key='user_special_note'");
					...
					<form class="form" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<select class="custom-select" required name="agent">
								...
								?>
								<option <?php if($agent_result['id'] == $result['agent_id']) echo "selected"; ?> value="<?php echo $agent_result['id']; ?>"><?php echo $agent_result['meta_value']; ?></option>
								<?php
									}
								}
						...
						<div class="form-group">
						    <textarea class="form-control" name="special_note" id="special_note" placeholder="User Special Note"><?php echo $meta['user_special_note']; ?></textarea>
						</div>
						<div class="form-group">
